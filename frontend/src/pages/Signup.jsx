...
import { Eye, EyeOff, Lock, Mail, User, ArrowRight, ShieldCheck, Layers, Zap } from "lucide-react";
      ...
      <div className="hidden md:flex md:w-1/2 relative bg-mesh-gradient flex-col justify-between p-12 overflow-hidden border-r border-slate-900/50">
        ...
        <div className="relative z-10 my-auto flex flex-col items-center justify-center">
          ...
          <div className="mt-8 text-center max-w-sm">
            <h3 className="text-lg font-bold text-white mb-2">Create Your Corporate Terminal</h3>
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="flex md:hidden items-center justify-center gap-3 mb-8">
            ...
            <div className="text-left">
              ...
              <p className="text-slate-400 text-xs font-medium">Enterprise Finance Platform</p>
            </div>
          </div>
          ...
          <div className="mb-8 text-center md:text-left">
            ...
            <p className="text-slate-400 mt-2 text-sm">
              Start managing and automating your UPI collections today.
            </p>
          </div>
          ...
          {error && (
            <div className="mb-6 p-4 bg-red-950/40 border border-red-500/20 rounded-xl flex items-start gap-3 animate-shake">
              ...
              <div>
                <h4 className="text-sm font-semibold text-red-200">Registration Failed</h4>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <p className="text-[11px] text-slate-500 leading-normal">
              By signing up, you agree to our Terms of Use and privacy guidelines.
            </p>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full relative overflow-hidden group bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white font-bold py-3.5 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 shadow-lg shadow-violet-900/25 active:scale-[0.98] cursor-pointer"
            >
              {loading ? (
                <>
          ...
          <div className="text-center">
            <p className="text-sm text-slate-400 font-medium">
              Already have an account?
              <Link to="/login" className="text-violet-400 hover:text-violet-300 font-semibold ml-1.5 transition-colors">
                Sign In
              </Link>
            </p>
          </div>
